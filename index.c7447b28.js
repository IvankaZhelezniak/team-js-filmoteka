 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kt(e,...t){throw Xt(e,...t)}function Jt(e,...t){return Xt(e,...t)}function Qt(e,t,n){const r=Object.assign(Object.assign({},zt()),{[t]:n});return new O("auth","Firebase",r).create(t,{appName:e.name})}function Xt(e,...t){if("string"!=typeof e){const n=t[0],r=[...t.slice(1)];return r[0]&&(r[0].appName=e.name),e._errorFactory.create(n,...r)}return Wt.create(e,...t)}function Yt(e,t,...n){if(!e)throw Xt(t,...n)}function Zt(e){const t="INTERNAL ASSERTION FAILED: "+e;throw Gt(t),new Error(t)}function en(e,t){e||Zt(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class rr{static credential(e,t){return Xn._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const n=nr.parseLink(t);return Yt(n,"argument-error"),Xn._fromEmailAndCode(e,n.code,n.tenantId)}constructor(){this.providerId=rr.PROVIDER_ID}}rr.PROVIDER_ID="password",rr.EMAIL_PASSWORD_SIGN_IN_METHOD="password",rr.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Jr=new Map;class Qr extends qr{async execute(){let e=Jr.get(this.auth._key());if(!e){try{const t=await async function(e,t){const n=Zr(t),r=Yr(e);if(!await r._isAvailable())return!1;const i="true"===await r._get(n);return await r._remove(n),i}(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(t)}catch(t){e=()=>Promise.reject(t)}Jr.set(this.auth._key(),e)}return this.bypassAuthState||Jr.set(this.auth._key(),(()=>Promise.resolve(null))),e()}async onAuthEvent(e){if("signInViaRedirect"===e.type)return super.onAuthEvent(e);if("unknown"!==e.type){if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}else this.resolve(null)}async onExecution(){}cleanUp(){}constructor(e,t,n=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,n),this.eventId=null}}function Xr(e,t){Jr.set(e._key(),t)}function Yr(e){return nn(e._redirectPersistence)}function Zr(e){return Pn("pendingRedirect",e.config.apiKey,e.name)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
...
//# sourceMappingURL=index.c7447b28.js.map
